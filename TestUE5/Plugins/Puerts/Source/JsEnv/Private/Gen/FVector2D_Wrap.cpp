...
// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 207,
// column 7> unsupported method : operator< bool (const FVector2D &) __attribute__((thiscall)) const

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 215,
// column 7> unsupported method : operator> bool (const FVector2D &) __attribute__((thiscall)) const

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 223,
// column 7> unsupported method : operator<= bool (const FVector2D &) __attribute__((thiscall)) const

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 231,
// column 7> unsupported method : operator>= bool (const FVector2D &) __attribute__((thiscall)) const

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 246,
// column 24> unsupported method : operator+= FVector2D (const FVector2D &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 254,
// column 24> unsupported method : operator-= FVector2D (const FVector2D &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 262,
// column 24> unsupported method : operator*= FVector2D (float) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 270,
// column 12> unsupported method : operator/= FVector2D (float) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 278,
// column 12> unsupported method : operator*= FVector2D (const FVector2D &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector2D.h', line 286,
// column 12> unsupported method : operator/= FVector2D (const FVector2D &) __attribute__((thiscall))
            ...
            puerts::DataTransfer::IsInstanceOf<FVector2D>(Isolate, Info[0]->ToObject(Context).ToLocalChecked()))
        {
            ...
            if (!Self)
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_op_Subtraction] Attempt to access a NULL self pointer");
                return;
            }
            auto MethodResult = Self->operator-(*Arg0);
            void* Ptr = new FVector2D(MethodResult);
...
static void FVector2DM_op_ExclusiveOr(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 1)
    {
            ...
            puerts::DataTransfer::IsInstanceOf<FVector2D>(Isolate, Info[0]->ToObject(Context).ToLocalChecked()))
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_op_ExclusiveOr] Attempt to access a NULL self pointer");
                return;
            }
            auto MethodResult = Self->operator^(*Arg0);
            auto V8Result = v8::Number::New(Isolate, MethodResult);
...
static void FVector2DM_op_UnaryNegation(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_op_UnaryNegation] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector2DM_ToDirectionAndLength(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 2)
    {
            ...
            Info[1]->IsObject() && puerts::DataTransfer::UnRef(Isolate, Info[1])->IsNumber())
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_ToDirectionAndLength] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector2DM_InitFromString(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 1)
    {
        if (Info[0]->IsString())
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_InitFromString] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector2DM_DiagnosticCheckNaN(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_DiagnosticCheckNaN] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector2DM_SphericalToUnitCartesian(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector2D::M_SphericalToUnitCartesian] Attempt to access a NULL self pointer");
                return;
            }
...
static void _FVector2DXGet_(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    puerts::DataTransfer::LinkOuter<FVector2D, float>(Context, Info.Holder(), V8Result);
    Info.GetReturnValue().Set(V8Result);
}
...
struct AutoRegisterForFVector2D
{
    AutoRegisterForFVector2D()
    {
        ...
        static puerts::JSPropertyInfo Properties[] = {
            {"X", _FVector2DXGet_, _FVector2DXSet_}, {"Y", _FVector2DYGet_, _FVector2DYSet_}, {0, 0, 0}};

        static puerts::JSFunctionInfo Methods[] = {{"op_Addition", FVector2DM_op_Addition},
            {"op_Subtraction", FVector2DM_op_Subtraction}, {"op_Multiply", FVector2DM_op_Multiply},
            {"op_Division", FVector2DM_op_Division}, {"op_BitwiseOr", FVector2DM_op_BitwiseOr},
            {"op_ExclusiveOr", FVector2DM_op_ExclusiveOr}, {"op_Equality", FVector2DM_op_Equality},
            {"op_Inequality", FVector2DM_op_Inequality}, {"op_UnaryNegation", FVector2DM_op_UnaryNegation},
            {"set_Item", FVector2DM_set_Item}, {"get_Item", FVector2DM_get_Item}, {"Component", FVector2DM_Component},
            {"Equals", FVector2DM_Equals}, {"Set", FVector2DM_Set}, {"GetMax", FVector2DM_GetMax},
            {"GetAbsMax", FVector2DM_GetAbsMax}, {"GetMin", FVector2DM_GetMin}, {"Size", FVector2DM_Size},
            {"SizeSquared", FVector2DM_SizeSquared}, {"GetRotated", FVector2DM_GetRotated},
            {"GetSafeNormal", FVector2DM_GetSafeNormal}, {"Normalize", FVector2DM_Normalize},
            {"IsNearlyZero", FVector2DM_IsNearlyZero}, {"ToDirectionAndLength", FVector2DM_ToDirectionAndLength},
            {"IsZero", FVector2DM_IsZero}, {"IntPoint", FVector2DM_IntPoint}, {"RoundToVector", FVector2DM_RoundToVector},
            ...
            {"DiagnosticCheckNaN", FVector2DM_DiagnosticCheckNaN}, {"ContainsNaN", FVector2DM_ContainsNaN},
            {"SphericalToUnitCartesian", FVector2DM_SphericalToUnitCartesian}, {0, 0}};
