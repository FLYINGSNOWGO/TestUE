...
// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector4.h', line 123,
// column 23> unsupported method : operator+= FVector4 (const FVector4 &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector4.h', line 139,
// column 23> unsupported method : operator-= FVector4 (const FVector4 &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector4.h', line 179,
// column 11> unsupported method : operator*= FVector4 (const FVector4 &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector4.h', line 187,
// column 11> unsupported method : operator/= FVector4 (const FVector4 &) __attribute__((thiscall))

// <SourceLocation file 'D:\\Program Files\\Epic Games\\UE_4.24\\Engine\\Source\\Runtime\\Core\\Public\\Math/Vector4.h', line 195,
// column 11> unsupported method : operator*= FVector4 (float) __attribute__((thiscall))
...
static void* _FVector4New_(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 2)
    {
        ...
        {
            FVector2D* Arg0 = puerts::DataTransfer::GetPointerFast<FVector2D>(Info[0]->ToObject(Context).ToLocalChecked());
            FVector2D* Arg1 = puerts::DataTransfer::GetPointerFast<FVector2D>(Info[1]->ToObject(Context).ToLocalChecked());
            FVector4* Obj = new FVector4(*Arg0, *Arg1);
        ...
        if (true)
        {
            ...
            if (!Self)
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_op_UnaryNegation] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector4M_GetUnsafeNormal3(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_GetUnsafeNormal3] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector4M_ToOrientationRotator(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_ToOrientationRotator] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector4M_ToOrientationQuat(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_ToOrientationQuat] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector4M_FindBestAxisVectors3(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 2)
    {
        if (Info[0]->IsObject() && puerts::DataTransfer::UnRef(Isolate, Info[0])->IsObject() &&
            ...
            puerts::DataTransfer::IsInstanceOf<FVector4>(
        ...
        {
            FVector4* Arg0 = puerts::DataTransfer::GetPointerFast<FVector4>(
                puerts::DataTransfer::UnRef(Isolate, Info[0])->ToObject(Context).ToLocalChecked());
            FVector4* Arg1 = puerts::DataTransfer::GetPointerFast<FVector4>(
                puerts::DataTransfer::UnRef(Isolate, Info[1])->ToObject(Context).ToLocalChecked());
            auto Self = puerts::DataTransfer::GetPointerFast<FVector4>(Info.Holder());
            if (!Self)
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_FindBestAxisVectors3] Attempt to access a NULL self pointer");
                return;
            }
...
static void FVector4M_DiagnosticCheckNaN(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    if (Info.Length() == 0)
    {
        if (true)
        {
            ...
            {
                puerts::DataTransfer::ThrowException(
                    Isolate, "[FVector4::M_DiagnosticCheckNaN] Attempt to access a NULL self pointer");
                return;
            }
...
static void _FVector4XGet_(const v8::FunctionCallbackInfo<v8::Value>& Info)
{
    ...
    puerts::DataTransfer::LinkOuter<FVector4, float>(Context, Info.Holder(), V8Result);
    Info.GetReturnValue().Set(V8Result);
}
...
struct AutoRegisterForFVector4
{
    AutoRegisterForFVector4()
    {
        ...
        static puerts::JSPropertyInfo Properties[] = {{"X", _FVector4XGet_, _FVector4XSet_}, {"Y", _FVector4YGet_, _FVector4YSet_},
            {"Z", _FVector4ZGet_, _FVector4ZSet_}, {"W", _FVector4WGet_, _FVector4WSet_}, {0, 0, 0}};

        static puerts::JSFunctionInfo Methods[] = {{"set_Item", FVector4M_set_Item}, {"get_Item", FVector4M_get_Item},
            {"op_UnaryNegation", FVector4M_op_UnaryNegation}, {"op_Addition", FVector4M_op_Addition},
            {"op_Subtraction", FVector4M_op_Subtraction}, {"op_Multiply", FVector4M_op_Multiply},
            {"op_Division", FVector4M_op_Division}, {"op_Equality", FVector4M_op_Equality},
            {"op_Inequality", FVector4M_op_Inequality}, {"op_ExclusiveOr", FVector4M_op_ExclusiveOr},
            {"Component", FVector4M_Component}, {"Equals", FVector4M_Equals}, {"IsUnit3", FVector4M_IsUnit3},
            {"ToString", FVector4M_ToString}, {"InitFromString", FVector4M_InitFromString},
            {"GetSafeNormal", FVector4M_GetSafeNormal}, {"GetUnsafeNormal3", FVector4M_GetUnsafeNormal3},
            {"ToOrientationRotator", FVector4M_ToOrientationRotator}, {"ToOrientationQuat", FVector4M_ToOrientationQuat},
            {"Rotation", FVector4M_Rotation}, {"Set", FVector4M_Set}, {"Size3", FVector4M_Size3},
            {"SizeSquared3", FVector4M_SizeSquared3}, {"Size", FVector4M_Size}, {"SizeSquared", FVector4M_SizeSquared},
            {"ContainsNaN", FVector4M_ContainsNaN}, {"IsNearlyZero3", FVector4M_IsNearlyZero3}, {"Reflect3", FVector4M_Reflect3},
            {"FindBestAxisVectors3", FVector4M_FindBestAxisVectors3}, {"DiagnosticCheckNaN", FVector4M_DiagnosticCheckNaN}, {0, 0}};
