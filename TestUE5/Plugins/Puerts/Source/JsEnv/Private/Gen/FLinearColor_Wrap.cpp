    ...
    if (Info.Length() == 2)
    {
            ...
            puerts::DataTransfer::IsInstanceOf<FLinearColor>(Isolate, Info[1]->ToObject(Context).ToLocalChecked()))
        {
            ...
            const FLinearColor* Arg1 =
                puerts::DataTransfer::GetPointerFast<FLinearColor>(Info[1]->ToObject(Context).ToLocalChecked());
...
struct AutoRegisterForFLinearColor
{
    AutoRegisterForFLinearColor()
    {
        ...
        static puerts::JSPropertyInfo Properties[] = {{"R", _FLinearColorRGet_, _FLinearColorRSet_},
        ...
        static puerts::JSFunctionInfo Methods[] = {{"ToRGBE", FLinearColorM_ToRGBE}, {"Component", FLinearColorM_Component},
            {"op_Addition", FLinearColorM_op_Addition}, {"op_Subtraction", FLinearColorM_op_Subtraction},
            {"op_Multiply", FLinearColorM_op_Multiply}, {"op_Division", FLinearColorM_op_Division},
            ...
            {"GetMax", FLinearColorM_GetMax}, {"IsAlmostBlack", FLinearColorM_IsAlmostBlack}, {"GetMin", FLinearColorM_GetMin},
            {"GetLuminance", FLinearColorM_GetLuminance}, {"ToString", FLinearColorM_ToString},
            {"InitFromString", FLinearColorM_InitFromString}, {0, 0}};

        static puerts::JSFunctionInfo Functions[] = {{"FromSRGBColor", FLinearColorS_FromSRGBColor},
