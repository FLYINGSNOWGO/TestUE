...
class A11 {
    ...
    Member5;
    Print() {
        Logger_1.Logger.log("testInterface ddddddddddddddddddddddd");
    }
    TestFun() {
        Logger_1.Logger.log("this.is A TestFun");
    }
}
class A22 extends A11 {
    TestFun() {
        Logger_1.Logger.log("this.is A22 TestFun");
    }
}
class A33 extends A22 {
    TestFun() {
        Logger_1.Logger.log("this.is A33 TestFun");
    }
    testA33() {
    }
}
var ue5 = function (r) {
    Logger_1.Logger.log('ue5 func:' + r);
    return true ? (function (t, e, n, o) {
        Logger_1.Logger.log(2, 3, 4, 5);
    }) :
        (function (t, e, n, o) {
            Logger_1.Logger.log(t, e, n, o);
        });
    var i;
    Logger_1.Logger.log("return ue5 func obj");
}(function (t, e) {
    Logger_1.Logger.log("function ", t, e);
});
//ue5(1, 2, 3, 4);
