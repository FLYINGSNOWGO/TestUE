...
struct SQLITEMANAGER_API FSQLiteIndex
{
...
USTRUCT(BlueprintType)
struct SQLITEMANAGER_API FSQLitePrimaryKey
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct SQLITEMANAGER_API FSQLiteTableField
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct SQLITEMANAGER_API FSQLiteTableRowSimulator
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct SQLITEMANAGER_API FSQLiteTable
{
	GENERATED_USTRUCT_BODY()
